...
import { ProductDetailsContext } from "src/pages/productDetails/context/ProductDetailsContext";
import {
  addToCart,
  cartList,
  cartListProduct,
...
import { getSingleProduct } from "src/pages/productDetails/services/ProductService";
import { slideImage } from "src/pages/productDetails/helper/slideImage";
import {
  isWish,
  isWishReq,
  unWishReq,
...
const ProductDetailsSectionComponent = () => {
  ...
  return (
    <Fragment>
      ...
      <ProductDetailsSectionTwoComponent />
    </Fragment>
  );
};

export default ProductDetailsSectionComponent;
