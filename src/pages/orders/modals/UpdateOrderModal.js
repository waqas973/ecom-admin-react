...
import {
  editOrderCategory,
  getAllOrder,
} from "src/shared/services/orderService";
import { editCategory } from "src/shared/services/categoryServcie";
...
const UpdateOrderModal = () => {
  ...
  const submitForm = async () => {
    ...
    let { data: responseData } = await editOrderCategory(oId, status);
